...
london_crime=run_all(target_name='value',ngen=20,task='regression',
                    path_or_data=path,
                      sample_n=-1,choice_method='quant',quant_or_num=0.5,
                      fix_skew=False,allowed_time=60*5,n_pop=[20,20,20,20],
                      test_perc=0.1,limit_n_for_feature_selection=19000,n_features=5,
                      target_sampling=0.9,pca_criterion_thres=0.05,fix_margins_low=True,
